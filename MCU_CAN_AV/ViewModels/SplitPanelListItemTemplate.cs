...
{
    public class SplitPanelListItemTemplate
    {
        ...
        public SplitPanelListItemTemplate(string? name)
        {
            if (name == null) name = "-";
            Label = name;

            Visible = new BehaviorSubject<bool>(false);
            Visible.Subscribe((_) =>
            {
        ...
        //~SplitPanelListItemTemplate() {

        //    //TODO check this again!
        //    Visible.Subscribe().Dispose();
        //}
        public string Label { get; }

        public IObservable<bool> Visible;
